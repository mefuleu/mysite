...
first_list = ['http://www.sdplay.com/shiwaiyouleshebei/', 'http://www.sdplay.com/shineiyouleshebei/',
              'http://www.sdplay.com/other/']
all_list=[]
response = requests.get(url='http://www.sdplay.com/suliaozuhehuati/list_16_2.html', headers=headers).text.encode('iso-8859-1').decode('utf-8')
...
for each_url in a_list:
    ...
    context_dict = {'title': title, 'product_specifications': product_specifications, 'usage_area': usage_area,
                    'applicable_scene': applicable_scene, 'use_age': use_age, 'ordering_hotline': ordering_hotline,
                    'typename_second_id': 15}
    all_list.append(context_dict)


with open('C:/Users/jackeyhate/Desktop/sd_status/suliaohuati2.json', 'w') as f_obj:
